...
-- =============================================================================
-- Network State mod: Special Economic Zone support.
-- SEZ status is written by NetworkState.lua into the savegame key
-- "NetworkState_SEZ_<playerID>" as a comma-separated list of minor civ IDs.
-- =============================================================================
local g_NetworkStateSEZCache = nil;
local function NetworkState_IsSEZOfActivePlayer(minorID)
	...
	return g_NetworkStateSEZCache[minorID] == true;
end
...
function OnDisplay()
	...
	-- Network State mod: show Special Economic Zone status.
	if (NetworkState_IsSEZOfActivePlayer(pPlayer:GetID())) then
		strText = "[COLOR_POSITIVE_TEXT]Special Economic Zone of the Network State[ENDCOLOR]: provides 25% of its [ICON_GOLD] Gold to you each turn, plus 25% of its [ICON_RESEARCH] Science while allied.[NEWLINE][NEWLINE]" .. strText;
	end
...
print("[NetworkState] CityStateDiploPopup (SEZ-aware) loaded from mod")
