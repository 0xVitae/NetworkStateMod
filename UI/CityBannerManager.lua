...
function RefreshCityBanner(cityBanner, iActiveTeam, iActivePlayer)
	...
	-- Network State mod: SEZs of the active player take the Network State's
	-- colors (white banner, near-black text).
	if (player:IsMinorCiv() and NetworkState_IsSEZOfActivePlayer(player:GetID())) then
		secondaryColor = {x = 1.0, y = 1.0, z = 1.0, w = 1.0};
		primaryColor = {x = 0.05, y = 0.05, z = 0.05, w = 1.0};
	end
...
print("[NetworkState] CityBannerManager (SEZ-aware) loaded from mod")
